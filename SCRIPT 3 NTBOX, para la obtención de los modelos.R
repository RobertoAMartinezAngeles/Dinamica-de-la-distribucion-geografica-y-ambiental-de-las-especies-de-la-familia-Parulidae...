...
library(readr)
occ <- read_csv("E:/Maestria/TRABAJO DE INVESTIGACION 4/DEPURACIONFINAL/Geothlypis_tolmiei_invierno.csv")
head(occ[, 1:3])
...
write.csv(dtrainGnv, "E:/Maestria/TRABAJO DE INVESTIGACION 4/PARTICION_ALEATORIA/Geothlypis_tolmiei_invierno_entrenamiento.csv", row.names = FALSE)
write.csv(dtestGnv, "E:/Maestria/TRABAJO DE INVESTIGACION 4/PARTICION_ALEATORIA/Geothlypis_tolmiei_invierno_validacion.csv", row.names = FALSE)
...
write.csv(final_data, "E:/Maestria/TRABAJO DE INVESTIGACION 4/PARTICION_ALEATORIA/Geothlypis_tolmiei_invierno_completo.csv", row.names = FALSE)
...
am <- sf::st_read("E:/Maestria/TRABAJO DE INVESTIGACION 4/POLIGONO/Geothlypis_tolmiei.shp") |> 
  as("Spatial")
...
writeRaster(modelo_conseso, "E:/Maestria/TRABAJO DE INVESTIGACION 4/MODELOS CONSENSO/Geothlypis_tolmiei_invierno.asc")
#Para visualizar el modelo consenso que ya se guardó.
prueba<- rast("E:/Maestria/TRABAJO DE INVESTIGACION 4/MODELOS CONSENSO/Geothlypis_tolmiei_invierno.asc")
plot(prueba)
#Para guardar las diferentes metricas de los modelos seleccionados(roc parcial, valores de omisión)
write.csv(e_selct_omr,"E:/Maestria/TRABAJO DE INVESTIGACION 4/MODELOS CONSENSO/Geothlypis_tolmiei_invierno.csv")                                              
#EXTRA
#Para guardar la elipsoide de volumen minimo.
# Se abre la ventana gráfica para guardar la imagen como PNG
png("E:/Maestria/TRABAJO DE INVESTIGACION 4/ELIPSES/tolmieiinviernoNTBOX.png", width = 800, height = 600)
...
dev.off()
#Para guardar en png
rgl::rgl.snapshot("E:/Maestria/TRABAJO DE INVESTIGACION 4/ELIPSES/tolmieiinviernoNTBOX.png")
